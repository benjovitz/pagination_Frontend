...
import { initServerPag } from "./pages/server-pagination/server-pagination.js";
...
window.addEventListener("load", async () => {
  ...
  const temlpateServerPag = await loadTemplate("./pages/server-pagination/server-pagination.html")
  ...
  router
    ...
    .on({
      ...
      "/server-pag": () => {
        renderTemplate(temlpateServerPag, "content")
        initServerPag()
      }
    })
